    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-10">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          ...
          <p>It serves as a virtual storefront where businesses can showcase their products, and customers can browse, select, and purchase items from the comfort of their homes.</p>
